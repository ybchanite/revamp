...
if (jQuery('#block-mainnavigation-2').css('display') === 'block'){
    jQuery(window).scroll(function(){
        ...
        /*check whether admin navbar exist*/
        if ((jQuery('.region-cityu-user-menu')[0])){
            if (jQuery(window).scrollTop()  >  offset.top + 200) {
                navbar.removeClass('container');
                navbar.addClass('container-fluid');
                jQuery('body > div.main-header.container > div').addClass('fixedNavbar');
            }
            ...
            if (jQuery(window).scrollTop()  <  offset.top + 200){
                ...
                jQuery('body > div.main-header.container > div').removeClass('fixedNavbar');
            }
...
jQuery( "#block-views-block-aboutcityu-student-alumni-block-1 img" ).click(function() {
    jQuery(this).parents('.views-field-title').siblings('.views-field-field-story').css('display','block');
    jQuery(this).parents('.views-field-title').siblings('.views-field-field-story').find('.people_story_summary').hide();
    jQuery(this).parents('.views-field-title').siblings('.views-field-field-story').find('.people_story_hidden').show();
...
if (jQuery('#block-researchhome-figures')[0]){
jQuery(window).scroll(function() {
...
/*random changing profiles position
  profile only interchange with others on the same row
  They cannot interchange with profiles on another row*/

window.setInterval(function(){

    jQuery( "#block-researchhomeresearchers .views-row" ).each(function() {

        var researcher = [];
        var random = [0, 1, 2, 3];    //indicate the occupation status            
        var randomIndex;
        ...
        jQuery(this).fadeOut(function(){
            ...
            for (i = 0; i < 4; i++) { 
                    researcher[i] = jQuery(this).children().eq(i).html();                   
                    jQuery(this).children().eq(i).empty();                                  
            }
            ...
            for (i = 0; i < 4; i++) { 
                ...
                jQuery(this).children().eq(i).html(researcher[randomIndex]);
...
jQuery( "#block-views-block-research-areas-block-1 .view_research_areas ol" ).each(function() {
    ...
    for (i = 0; i < dHeader + 1; i++) { 
            if (i === 0){
                ...
                item = jQuery(this).find('li:nth-child(' + i + ') .field--name-field-dept-url-official a').text();
...
jQuery('#block-views-block-research-areas-block-1 .view_research_areas .view_research_areas_ul li:not(:nth-child(1))').click(function(){
        ...
        var target = jQuery(this).parent().parent().find(".col-sm-12 ol li:nth-child(" + index + ")");   
        jQuery(this).parent().parent().find(".col-sm-12 ol").css('display','block');
        jQuery(this).parent().parent().find('.col-sm-12 ol li').css('display','none');
...
jQuery('.landing_research_phdfscheme .col-sm-2 p').click(function(){
        var index = jQuery("p").index(jQuery(this)) - 2 ;
...
jQuery(window).load(function() {
    ...
    if (temp > -1){
        ...
        jQuery('#block-views-block-list-of-colleges-and-schools-block-2 .view-list-of-colleges-and-schools .view-header strong').text("-");
