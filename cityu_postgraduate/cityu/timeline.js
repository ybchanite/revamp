...
jQuery('#block-views-block-cityu-postgraduate-research-atimeline-block-2 .views-field-field-at-step .field-content, #block-views-block-cityu-postgraduate-doctorate-atimeline-block-2 .views-field-field-at-step .field-content, #block-views-block-cityu-postgraduate-taught-atimeline-block-2 .views-field-field-at-step .field-content').click(function(){
...
if(jQuery('#block-views-block-cityu-postgraduate-research-atimeline-block-2').length){
    sidebar = jQuery("#block-views-block-cityu-postgraduate-research-atimeline-block-2");
}
else if(jQuery('#block-views-block-cityu-postgraduate-doctorate-atimeline-block-2').length){
    sidebar = jQuery("#block-views-block-cityu-postgraduate-doctorate-atimeline-block-2");
}else if(jQuery('#block-views-block-cityu-postgraduate-taught-atimeline-block-2').length){
    sidebar = jQuery("#block-views-block-cityu-postgraduate-taught-atimeline-block-2");
}
