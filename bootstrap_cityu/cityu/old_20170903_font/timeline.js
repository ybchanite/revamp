...
jQuery('.views-field-field-at-step .field-content').click(function(){
        
        jQuery('.form-group .view-content .views-row .views-field .field-content').not(jQuery(this)).css('background', '#eee').css('color', '#333');
        jQuery(this).css('background', '#9a7894').css('color', '#fff');
...
jQuery('.taxonomy_timeline_deadline').click(function(){
        var target = jQuery("#block-body-2 > div h2");
